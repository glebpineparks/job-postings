    ...
    public static function get_job_fields( $position = 'sort-left', $post_id ){
        ...
        if( $fields ){
            ...
            foreach ($fields as $key => $field) {
                ...
                switch($key){
                    ...
                    case 'position_valid_through';
                        ...
                        if( $value ) {
                            ...
                            self::$json_ld['validThrough'] = $value;
                        }
                    break;
                        ...
                        $out .= '<div class="jobs-row clearfix '.$key.' type-'.$type.' '.$class.'">';
                            ...
                            if( $key != 'position_base_salary' ){
                                switch ( $type ) {
                                    ...
                                    case 'location':
                                        ...
                                        if($full_address) $out .= $icon . implode(', ', $full_address);
                            ...
                            if( $key == 'position_base_salary' ){
                                ...
                                if($currency_symbol){
                                    ...
                                    $to = '';
                                    if( $upto ) {
                                        //$starting = apply_filters('job-postings/starting-salary', '<span>'._x('From', 'jobs-field', 'job-postings').' </span>');

                                        //$to = apply_filters('job-postings/upto-salary', '<span>'._x('Up to', 'jobs-field', 'job-postings').' </span>');
                                    }
                                    ...
                                    //if($this->schema_type != 'json-ld') $out .= '<meta itemprop="salaryCurrency" content="'.$currency_symbol.'">';
                ...
                if( $key == 'position_apply_now' && JobSingleView::$inline_form_in == false ){
                ...
                if( $key == 'position_inline_apply_now' && JobSingleView::$modal_form_in == false ){
            ...
            if( JobSingleView::$inline_form_in == false && JobSingleView::$modal_in == false  ) {
                //JobSingleView::$modal_form_in = true;

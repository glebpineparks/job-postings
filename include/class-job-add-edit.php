	...
	*/
    ...
    public static function renderFields( $position = 'sort-left', $fields, $post, $append_class_1 = '', $append_class_2 = ''  ){
    	...
    	if( $fields ){
    		...
    		foreach ($fields as $index => $field) {
    			...
    			echo '<div class="jobs-row clearfix type-'.$type.'">';
    ...
    public static function save( $post_id ){
        ...
        if( isset( $_POST['job_custom_message'] ) ){
            $notification_message = wp_kses( $_POST['job_custom_message'], $allowed );
            update_post_meta( $post_id, 'job_custom_message', $notification_message );
        }

        if( isset( $_POST['job_notification_message'] ) ){
            $notification_message = wp_kses( $_POST['job_notification_message'], $allowed );
        ...
        if( $fields ){
            ...
            foreach ($fields as $index => $field) {
                ...
                if( isset( $_POST[$key] ) ){
                    $field_key = wp_kses( $_POST[$key], $allowed );

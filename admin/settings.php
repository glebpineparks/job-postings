											...
											<div class="column jfw_col_2">
												<?php if($languages){
													foreach ($languages as $lang => $language) {
														...
														echo '<input id="label-field-'.$lang.'"type="text" class="hg_label" name="label_'.$lang.'" value="'.$val.'"/>';
													}
												} ?>
											</div>
													...
													<?php if($languages){
														foreach ($languages as $lang => $language) {
															echo '<div class="row-separation">';
																...
																echo '<input id="rfiles-accepted-message-field-'.$lang.'"type="text" class="hg_label" name="files_accepted_message_'.$lang.'" value="'.$val.'"/>';
